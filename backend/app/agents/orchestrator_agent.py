...
def _sub_agent_system_prompt() -> str:
    return (
        ...
        "- For image assets (logos, backgrounds, hero images, icons, etc.) call `generate_image`. "
        "You MUST provide both `prompt` and `output_path` — for example: "
        "generate_image(prompt='a glowing blue logo on dark background', output_path='public/images/logo.png'). "
